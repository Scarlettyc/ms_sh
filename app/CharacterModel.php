...
{
	protected $fillable = ['ch_id','ch_title','u_id','w_id','m_id','core_id','ch_lv','ch_exp','ch_star','ch_hp_max','ch_shield','ch_stam','ch_atk','ch_def','ch_res','ch_crit','ch_cd','ch_spd','ch_img','update_at','createdate'];
