...
class ShopController extends Controller
{
	public function shopCoin(Request $request){
		...
		$resourceShop=$inAppModel->select('item_id','item_type','item_min_quantity','item_max_times','item_spend'*'item_min_quantity')->where('start_date','<=',$datetime)->where('end_date','>=',$datetime)->get();
